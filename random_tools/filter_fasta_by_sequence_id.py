...
#This script extracts or removes fasta sequences by sequence IDs given in a list

#written in python/2.7.9

#To see usage: python filter_fasta_by_sequence_id.py -h

#To use on Artemis, run "module load python" first

#Please contact Yuanyuan in case of any issues

################

arg_parse = argparse.ArgumentParser(description='This script extracts or removes fasta sequences by sequence IDs.')
...
arg_parse.add_argument('--remove', action='store_const', default=1, const=0, help='Remove sequences (Default: extract sequences)')
